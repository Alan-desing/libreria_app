...
public class estilos {
    ...
    /**
     * (Opcional) Inicializa FlatLaf si está en el classpath para soportar placeholders.
     * Si no está, sigue con el L&F por defecto sin romper.
     */
    public static void initLookAndFeel() {
        try {
            ...
            // usa el look & feel por defecto
        }
        UIManager.put("Panel.background", COLOR_FONDO);
    }

    // 🔘 Botón redondeado con la paleta del proyecto
    ...
    public static void estilizarCampo(JTextComponent c) {
        ...
        Border line   = new LineBorder(new Color(0xD9D9D9), 1, true);
